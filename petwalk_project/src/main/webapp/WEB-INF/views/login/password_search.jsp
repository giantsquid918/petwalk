  ...
  <div class="container"> 
   <div class="row">   
    <div class="col-md-6" align="center">
     <h1><img src="./img/petmark.png" height="45"  />비밀번호 찾기</h1> 
    </div>
  <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown mr-3">      
       <div class="py-2">
        <a href="./LoginPage" class="nav-link text-white">
   ...
   <div class="row">
    <div class="col-9 mx-auto">
     <div class="card">
      ...
      <div class="card-body">
       <form action="./SearchPassword" method="post" id="signupForm" enctype="application/x-www-form-urlencoded">
        <fieldset>
    ...
    <div class="col-9 mx-auto py-3 mb-3">
     <div>      
      <span>
       <button type="button" class="btn btn-outline-success" onclick="location.href='./SearchId'">
       아이디 찾기
       </button>
      </span>
      <span>
